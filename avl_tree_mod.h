...
private:
	...
	void remove( const Comparable & x, AvlNode * & t, float &count )
	{
		count++;
		if( t == nullptr )
			return;   // Item not found; do nothing
	...
	Comparable find(const Comparable & x, AvlNode *t, float &count) const
	{
		if( t == nullptr )
			return Comparable("Not Found","Not Found");
		else if( x < t->element ){
	...
	*****************************************************/
	...
	int intPathLength(AvlNode *t, int value){
		if (t == nullptr )
		{
			return 0;
		}
